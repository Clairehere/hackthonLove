...
public class GalaxyActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final String match = intent1.getStringExtra("match");



        if (match.equals("bebe1")) {

            Toast.makeText(this, "Tu t'es bien reproduis, jeune padawan", Toast.LENGTH_LONG).show();
        } else if (match.equals("match1")) {

            Toast.makeText(this, "Ta raison, il vaut mieux aller voir ailleurs", Toast.LENGTH_LONG).show();

        } else if (match.equals("bebe2")) {
            Toast.makeText(this, "Bravo, des petits toi sont en cours", Toast.LENGTH_LONG).show();
        } else if (match.equals("match2")) {
            Toast.makeText(this, "Un jour tu trouvera l'amour", Toast.LENGTH_LONG).show();
        } else if (match.equals("bebe4")) {
            Toast.makeText(this, "Tu t'es bien reproduis, jeune padawan", Toast.LENGTH_LONG).show();
        }else if (match.equals("match4")) {
            Toast.makeText(this, "Va faire un tour sur la planete à côté", Toast.LENGTH_LONG).show();
        }
        else if (match.equals("bebe5")) {
            Toast.makeText(this, "Des bébés, des bébés !!!", Toast.LENGTH_LONG).show();
        }
        else if (match.equals("match5")) {
            Toast.makeText(this, "Bou", Toast.LENGTH_LONG).show();
        }
        ...
        if (PlaneteActivity.PLANETE) {
            /*
            ArrayList<ProfilModel> mListCoeur = getIntent().getExtras().getParcelableArrayList("coeur");
            final ListView listCoeur = findViewById(R.id.lv_like_planeteCock);
            final LikeAdapteur adapter0 = new LikeAdapteur(GalaxyActivity.this, mListCoeur);
            listCoeur.setAdapter(adapter0);
            */
        }
